            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-auto">Update Coupon</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.coupon.update', $coupon->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    <input type="text" name="code"
                                        class="form-control @error('code')
                                            is-invalid
                                        @enderror"
                                        value="{{ $coupon->code }}" placeholder="Code">
                                    @error('code')
                                        <strong class="text-danger">
                                            {{ $message }}
                                        </strong>
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    @enderror"
                                        value="{{ $coupon->quantity }}" placeholder="Quantity">
                                    @error('quantity')
                                        <strong class="text-danger">
                                            {{ $message }}
                                        </strong>
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    @enderror"
                                        value="{{ $coupon->min_purchase_amount }}" placeholder="Min Purchase Amount">
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    <input type="date"
                                        ...
                                        is-invalid
                                    @enderror"
                                        name="expire_date" value="{{ $coupon->expire_date }}">
                                    @error('expire_date')
                                        <strong class="text-danger">
                                            {{ $message }}
                                        </strong>
