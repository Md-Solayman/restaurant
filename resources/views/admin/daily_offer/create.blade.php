            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-auto text-center">Create Daily Offer</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.daily_offer.store') }}" method="POST">
                            @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function formatProduct(product) {
                var productInfo = $('<span><img src="' + '/uploads/product/' + product.image_url +
                    '" width="30"> ' +
                    product.text + ' </span>');
                return productInfo;
            }
