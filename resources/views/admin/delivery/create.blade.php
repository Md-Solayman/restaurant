            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="m-auto text-center">Create Delivery</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.delivery.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-12 my-2">
                                    ...
                                    <input type="text" name="area_name"
                                        class="form-control @error('area_name')
                                            is-invalid
                                        @enderror"
                                        value="{{ old('area_name') }}" placeholder="Area Name">
                                    @error('area_name')
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    <input type="text" name="min_delivery_time"
                                        class="form-control @error('min_delivery_time')
                                            is-invalid
                                        @enderror"
                                        value="{{ old('min_delivery_time') }}" placeholder="Min Delivery Time">
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    @enderror"
                                        value="{{ old('max_delivery_time') }}" placeholder="Max Delivery Time">
                                ...
                                <div class="col-lg-6 my-2">
                                    ...
                                    @enderror"
                                        value="{{ old('delivery_charge') }}" placeholder="Delivery Charge">
