                                                                    ...
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <select id="custom-menu-item-pages"
                                                                                class="menu-item-textbox custom-page">
                                                                                <option value="">Select Page
                                                                                </option>
                                                                                <option value="Home" data-url="/">
                                                                                    Home</option>

                                                                                <option value="About"
                                                                                    data-url="/about">About</option>

                                                                                <option value="Products"
                                                                                    data-url="/products">Products
                                                                                </option>

                                                                                <option value="Pages" data-url="#">
                                                                                    Pages</option>

                                                                                <option value="Terms & Conditions"
                                                                                    data-url="/terms-condition">
                                                                                    Terms & Conditions</option>

                                                                                <option value="Testimonials"
                                                                                    data-url="/testimonial">
                                                                                    Testimonials</option>

                                                                                <option value="Chefs" data-url="/chef">
                                                                                    Chefs</option>
                                                                    ...
                                                                    <p id="menu-item-url-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <input id="custom-menu-item-url"
                                                                                name="url" type="text"
                                                                                class="menu-item-textbox customUrl"
                                                                                placeholder="URL">
                                                                        </label>
                                                                    </p>
                                                                    ...
                                                                    <p id="menu-item-name-wrap">
                                                                        <label class="howto"
                                                                            ...
                                                                            <input id="custom-menu-item-name"
                                                                                ...
                                                                                class="regular-text menu-item-textbox input-with-default-title customLabel text-dark"
